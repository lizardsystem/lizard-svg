...
DATABASES = {
    ...
    'fewsnorm-remote': {
        ...
        'USER': 'buildout',
        'PASSWORD': 'buildout',
        'HOST': '10.100.253.110',  # empty string for localhost.
        'PORT': '5432',  # empty string for default.
        'DEFAULT_TABLESPACE': 'nskv00_opdb_dat01',
        },
    }
SITE_ID = 1
INSTALLED_APPS = [
...
try:
    ...
    from lizard_svg.local_testsettings import *
except ImportError:
    pass
